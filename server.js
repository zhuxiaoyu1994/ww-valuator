...
const CONFIG = {
  weights: {
    ...
    hotNoSigMult: 0.15,
    hotNoSigC6Mult: 0.25,
    c6TierWeights: { S: 1.0, A: 0.8, B: 0.6, C: 0.4, D: 0.2 },
    c6MultiBonus: [
      { count: 2, bonus: 0.20 },
      { count: 3, bonus: 0.50 },
      { count: 4, bonus: 1.00 },
  ...
  constPremiums: {},
  teamPremiums: {
    '爱弥斯队': { chars: ['爱弥斯', '卡提希娅', '守岸人'], multiplier: 1.2, enabled: true },
    '绯雪队': { chars: ['绯雪', '卡提希娅', '守岸人'], multiplier: 1.2, enabled: true },
    '琳奈队': { chars: ['琳奈', '千咲', '守岸人'], multiplier: 1.2, enabled: true },
    '莫宁队': { chars: ['莫宁', '卡提希娅', '守岸人'], multiplier: 1.15, enabled: true },
    '达妮娅队': { chars: ['达妮娅', '洛瑟菈', '守岸人'], multiplier: 1.15, enabled: true },
    '夏空队': { chars: ['夏空', '洛瑟菈', '守岸人'], multiplier: 1.15, enabled: true },
    '穗穗队': { chars: ['穗穗', '卡提希娅', '守岸人'], multiplier: 1.15, enabled: true },
  },
  pullTiers: [
    { minPull: 0, maxPull: 200, perPullPrice: 0.8 },
    { minPull: 200, maxPull: 400, perPullPrice: 0.9 },
    { minPull: 400, maxPull: 500, perPullPrice: 1.0 },
    { minPull: 500, maxPull: 700, perPullPrice: 1.2 },
    { minPull: 700, maxPull: 1000, perPullPrice: 1.5 },
    { minPull: 1000, maxPull: Infinity, perPullPrice: 2.0 },
  ],
  yellowTiers: [
    { minYellow: 0, maxYellow: 10, coefficient: 0.3 },
    { minYellow: 10, maxYellow: 20, coefficient: 0.5 },
    { minYellow: 20, maxYellow: 30, coefficient: 0.7 },
    { minYellow: 30, maxYellow: 40, coefficient: 0.9 },
    { minYellow: 40, maxYellow: 50, coefficient: 1.0 },
    { minYellow: 50, maxYellow: 60, coefficient: 1.1 },
    { minYellow: 60, maxYellow: 70, coefficient: 1.2 },
    { minYellow: 70, maxYellow: 80, coefficient: 1.3 },
    { minYellow: 80, maxYellow: 90, coefficient: 1.4 },
    { minYellow: 90, maxYellow: Infinity, coefficient: 1.5 },
  ],
};
