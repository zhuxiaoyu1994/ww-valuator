...
<body>
  ...
  <nav class="top-nav" id="top-nav">
    <div class="top-nav-inner">
      ...
      <div class="nav-links">
        ...
        <a href="/wuwa/guide" class="nav-link active">使用须知</a>
  ...
  <div class="container">
    ...
    <div class="page-header">
      <div class="page-kicker">USER GUIDE</div>
      <h1 class="page-title">使用须知</h1>
      <p class="page-subtitle">了解工具的正确使用方式、数据来源和免责声明，帮助你更准确地评估账号价值</p>
    ...
    <div class="content-wrapper">
      ...
      <aside class="side-toc">
        ...
        <ul class="toc-list">
          ...
          <li><a href="#data-source">数据来源</a></li>
          <li><a href="#accuracy">准确性说明</a></li>
      ...
      <article class="article-content">
        <div class="placeholder-hint">
          ...
          <div class="placeholder-text">内容待补充</div>
          <div class="placeholder-subtext">请将使用须知的内容发给我，我会帮你整理排版</div>
        </div>
      </article>
    </div>
  </div>
...
module.exports = getGuidePageHTML;
